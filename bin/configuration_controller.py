...
class ConfigController:
    def update_api_key(self):
        ...
        if len(api_key) != Config.EXPECTED_API_KEY_LENGTH:
            Utils.log(
                ...
                Config.LoggingModes.ALL)
        try:
            f = open('api_key', 'w+')
            f.write(api_key)
            Utils.log("API Key Saved!", Config.LoggingModes.ALL)
        except:
            Utils.log("Failed to write API Key", Config.LoggingModes.ALL)
    ...
    def view_api_key(self):
        try:
            ...
            Utils.log("Failed to open API Key", Config.LoggingModes.ALL)
    ...
    def update_secret_key(self):
        ...
        try:
            f = open('secret_key', 'w+')
            f.write(secret_key)
            Utils.log("Secret Key Saved!", Config.LoggingModes.ALL)
        except:
            Utils.log("Failed to write Secret Key", Config.LoggingModes.ALL)
    ...
    def view_secret_key(self):
        try:
            ...
            Utils.log("Failed to open Secret Key", Config.LoggingModes.ALL)
